...
message = ""
$.shareuuid = "2e5f9c0490304aac993442b701a1d2e1" //
    !(async () => {
        if (!cookiesArr[0]) {
...
function genToken() {
    let config = {
        ...
        body: 'body=%7B%22action%22%3A%22to%22%2C%22to%22%3A%22https%253A%252F%252Flzdz-isv.isvjcloud.com%252Fdingzhi%252Fyili%252Fyangniu%252Factivity%252F5070687%253FactivityId%253Ddz2103100001340201%2526shareUuid%253D2e5f9c0490304aac993442b701a1d2e1%2526adsource%253Dziying%2526shareuserid4minipg%253Du%252FcWHIy7%252Fx3Ij%252BHjfbnnePkaL5GGqMTUc8u%252Fotw2E%252Ba7Ak3lgFoFQlZmf45w8Jzw%2526shopid%253D1000013402%22%7D&',
        headers: {
            'Host': 'api.m.jd.com',
            'accept': '*/*',
